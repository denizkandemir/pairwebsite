        ...
        <div className="navbar-container">
            <div className="navbar-content-container">
                ...
                <div className="navbar-center-container">
                    <NavLink className={({ isActive }) => isActive ? "navbar-link active" : "navbar-link"} to="/newsletter">Newsletter</NavLink>
                    <NavLink className={({ isActive }) => isActive ? "navbar-link active" : "navbar-link"} to="/events">Events</NavLink>
                    <NavLink className={({ isActive }) => isActive ? "navbar-link active" : "navbar-link"} to="/aboutUs">About Us</NavLink>
                    <NavLink className={({ isActive }) => isActive ? "navbar-link active" : "navbar-link"} to="/contact">Contact</NavLink>
                </div>
                <div className="navbar-right-container">
                    <div className="navbar-social-icons-container">


                        <a href="#" className="social-icon" aria-label="PAIR Instagram">
                        ...
                        <a href="#" className="social-icon" aria-label="PAIR LinkedIn">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="#" className="social-icon" aria-label="PAIR Facebook">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div onClick={openSidebar} onKeyDown={handleSidebarKeyDown} tabIndex={0} className="navbar-sidebar-icon-container" aria-label="Open menu" role="button">
