        ...
        <div className="navbar-container">
            <div className="navbar-content-container">
                ...
                <div className="navbar-center-container">
                    <Link className="navbar-link" to="/newsletter">Articles & Updates</Link>
                ...
                <div className="navbar-right-container">
                    <div className="navbar-social-icons-container">
                        ...
                        <a href="https://www.instagram.com/pair.skn/" className="social-icon" aria-label="Instagram">
                        ...
                        <a href="https://www.linkedin.com/in/sknpair/" className="social-icon" aria-label="LinkedIn">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="https://www.facebook.com/share/17gu58MeTJ/" className="social-icon" aria-label="Facebook">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
